...
body_name = "g_phobos_287m_spc_0000n00000_v002.obj" # name of the body input
#body_name = ["g_phobos_287m_spc_0000n00000_v002.obj","g_deimos_162m_spc_0000n00000_v001"] # name of the body input
...
# Add extra inputs 
State.add_path('texture_path',os.path.join(State.path["input_path"],'body','texture','Phobos grayscale.jpg'))
State.add_path('uv_data_path',os.path.join(State.path["input_path"],'body','uv data','g_phobos_287m_spc_0000n00000_v002.json'))
