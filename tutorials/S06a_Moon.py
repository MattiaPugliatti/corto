"""
Tutorial script to render images of the S06a_Moon scenario. 

In this scenario, the entire Moon can be rendered as a single body, which is useful for far-approach and mediumd navigation regimes
...
material = corto.Shading.create_new_material('S06a_Moon_material')
